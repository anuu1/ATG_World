...
import { MdToday, MdOutlineLocationOn } from "react-icons/md";
import { useState } from "react";

const Event = ({ title, date, location, link, author, imageURL, authorIconURL, views }) => {
        ...
        <div className="w-full flex flex-col border-2 border-[#E0E0E0] rounded-lg font-ibm">
            ...
            <div className=" p-4 flex flex-col gap-1 h-full">
                <div className=" flex items-center gap-1">
                    ...
                    <h2 className="text-lg font-medium">Meetup</h2>
                </div>
                ...
                <div className=" flex w-full h-10 items-center justify-center border border-[#A9AEB8] rounded-[8px]">
                    <a href={link}>
                        <button className=" text-[#E56135] text-[14px] font-bold">
                            Visit Website
                        </button>
                    </a>
                </div>
